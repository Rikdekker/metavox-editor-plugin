# MetaVox Editor Plugin — ONLYOFFICE / Euro-Office

> This is the **ONLYOFFICE / Euro-Office** integration, built on the ONLYOFFICE plugin SDK
> (`window.Asc.plugin.*`). It does **not** work with Collabora Online — see the
> [repository README](../README.md) for the platform overview and the Collabora approach.
...
```
metavox-editor-plugin/onlyoffice/
